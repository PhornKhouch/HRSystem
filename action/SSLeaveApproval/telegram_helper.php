...
function GetMessageForLeaveApproved($name, $leaveType, $fromDate, $toDate, $status) {

    return "<b>----Leave Approved----</b>\n\n" .
           "<b>Employee Name:</b> {$name}\n" .
           "<b>Leave Type:</b> {$leaveType}\n" .
           "<b>From Date:</b> {$fromDate}\n" .
           "<b>To Date:</b> {$toDate}\n" .
...
function GetMessageForLeaveRejected($name, $leaveType, $fromDate, $toDate, $status) {

    return "<b>----Leave Reject----</b>\n\n" .
           "<b>Employee Name:</b> {$name}\n" .
           "<b>Leave Type:</b> {$leaveType}\n" .
           "<b>From Date:</b> {$fromDate}\n" .
           "<b>To Date:</b> {$toDate}\n" .
