                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">Bonus List</h4>
                            <a href="create.php" class="btn btn-primary">
                                <i class="fas fa-plus me-2"></i>New Bonus
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="bonusTable" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Actions</th>
                                    <th>Employee Code</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($row['BonusType']); ?></td>
            ...
            $('.delete-btn').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = `../../action/PRBonus/delete.php?id=${encodeURIComponent(id)}`;
                    }
                });
            });
        });
