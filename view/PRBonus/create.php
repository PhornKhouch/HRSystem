                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">Create New Bonus</h4>
                    ...
                    <div class="card-body">
                        <form action="../../action/PRBonus/create.php" method="POST" id="bonusForm">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="bonusType" id="" class="form-select" required>
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Save Bonus
                                </button>
                            </div>
                        </form>
                    </div>
